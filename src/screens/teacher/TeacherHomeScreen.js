...
const TeacherHomeScreen = () => {
    ...
    const result = ()=>{
        ApiManager.get(`/teacher/homeclass`, {
            headers:{
                 ...
                 <View style={styles.currentClassContainer}>
                     <View style={styles.currentClass}> 
                        ...
                        <View style={styles.button}>
                            ...
                            <View style={{paddingLeft: 130, flex:2,backgroundColor: "white", justifyContent: 'space-between', flexDirection: "row", alignItems: "center", marginLeft: 10, marginRight: 10, backgroundColor: "#34b7f1"}}>
                                <Button title='Details' color={"purple"} onPress={()=> navigation.navigate('AfterStartClass')}></Button>
                                <Button title='Student' color={"purple"} onPress={()=>navigation.navigate('StudentJoinDetails')}></Button>
                            </View>
                        </View>   
                    </View>
                    </View>
              ...
              <View style={styles.task}>
                  ...
                  <View style={styles.taskWrapper}>
                      <View style={styles.taskWrapperFunction}>
                          ...
                          <View style={styles.taskFunction}>
                              <View style={styles.coreTask}>
                                  <TouchableOpacity onPress={()=> navigation.navigate('TeacherSubject')}>
                                      <View style={styles.logo}>
